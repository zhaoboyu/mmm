//
//  LLFBezierCurveView.m
//  YDJR
//
//  Created by 吕利峰 on 2017/5/26.
//  Copyright © 2017年 agree.com.cn. All rights reserved.
//

#import "LLFBezierCurveView.h"
static CGRect myFrame;

@interface LLFBezierCurveView ()

@end
@implementation LLFBezierCurveView
//初始化画布
...
-(void)drawXYLine:(NSMutableArray *)x_names{
    ...
    shapeLayer.strokeColor = XYQColor(217, 217, 217).CGColor;
 ...
 *  画折线图
 */
-(void)drawLineChartViewWithX_Value_Names:(NSMutableArray *)x_names TargetValues:(NSMutableArray *)targetValues LineType:(BZLineType) lineType{
    ...
    CGPoint PrePonit;
    switch (lineType) {
        case BZLineType_Straight: //直线
        for (int i =1; i<allPoints.count; i++) {
            CGPoint point = [allPoints[i] CGPointValue];
            [path addLineToPoint:point];
        }
        break;
        case BZLineType_Curve:   //曲线
