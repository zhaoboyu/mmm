...
{
    NSString *filePath = [documentPath stringByAppendingPathComponent:[NSString stringWithFormat:@"%@.pdf",filename]];
    return filePath;
}
...
{
//    NSString *fileFullPath = [documentPath stringByAppendingPathComponent:[NSString stringWithFormat:@"%@.pdf",destFileName]];
