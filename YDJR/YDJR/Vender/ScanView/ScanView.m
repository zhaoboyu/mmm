...
//扫码区域各种参数
@property (nonatomic, strong) ScanViewStyle* viewStyle;
...
//线条扫码动画封装
@property (nonatomic,strong)ScanLineAnimation *scanLineAnimation;
//网格扫码动画封装
@property (nonatomic,strong)ScanNetAnimation *scanNetAnimation;
...
-(id)initWithFrame:(CGRect)frame style:(ScanViewStyle*)style
{
    ...
    switch (_viewStyle.anmiationStyle)
    {
        case LBXScanViewAnimationStyle_LineMove:
        {
            ...
            if (!_scanLineAnimation)
                self.scanLineAnimation = [[ScanLineAnimation alloc]init];
        ...
        case LBXScanViewAnimationStyle_NetGrid:
        {
            ...
            if(self.viewStyle.HorizontalScan){
                [_scanNetAnimation startAnimatingWithRect:_scanRetangleRect
                                                   InView:self
                                                    Image:_viewStyle.animationImage andWithDirection:1];
            }else{
                [_scanNetAnimation startAnimatingWithRect:_scanRetangleRect
                                                   InView:self
                                                    Image:_viewStyle.animationImage andWithDirection:0];
            }
